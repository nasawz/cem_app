                    ...
                    <div className="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
                        ...
                        <ul className="nav navbar-toolbar">
                            ...
                            <li className="nav-item dropdown dropdown-fw dropdown-mega">
                                <a className="nav-link" data-toggle="dropdown" href="#" aria-expanded="false" data-animation="fade" role="button">Mega
                                ...
                                <div className="dropdown-menu" role="menu">
                                    <div className="mega-content">
                                        <div className="row">
                                                ...
                                                <ul className="blocks-2">
                                                    <li className="mega-menu m-0">
                                                        <ul className="list-icons">
                                                            <li>
                                                                <i className="wb-chevron-right-mini" aria-hidden="true"></i>
                                            ...
                                            <div className="col-xs-12 col-md-4">
                                                <h5>Media
                                                    <span className="label label-pill label-success">4</span>
                                                </h5>
                                                <ul className="blocks-3">
                                                    <li>
                                                        <a className="thumbnail m-0" href="javascript:void(0)">
                                                            <img className="w-full" src="assets/photos/placeholder.png" alt="..."/>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a className="thumbnail m-0" href="javascript:void(0)">
                        ...
                        <ul className="nav navbar-toolbar navbar-right navbar-toolbar-right">
                            ...
                            <li className="nav-item dropdown">
                                <a className="nav-link" data-toggle="dropdown" href="javascript:void(0)" title="Messages" aria-expanded="false" data-animation="scale-up" role="button">
